...
<div class="row">
	...
	<div class="col-10">
		<h3 class="text-center text-muted">Update Post</h3>
	</div>
	<div class="col-1"></div>
</div>
	<div class="container ">
		...
		<div class="row justify-content-center">
			<div class="col-md-6">
				<div class="card border-success mb-3 p-3">
					...
					<?php echo form_open("welcome/updatePost/{$post->id}");?>
					  ...
					  <div class="form-group">
					    ...
					    <?php echo form_textarea(['name'=>'description','placeholder'=>'enter description','rows'=>'3', 'class'=>'form-control', 'value'=>set_value('description', $post->description) ]) ;?>
					  ...
					  <div class="row justify-content-center">
					  	<div class="col-6">
							<?php echo form_submit(['name'=>'submit','value'=>'Update  post','class'=>'btn btn-outline-success btn-block'])?>  		
					  	</div>
					  </div>
